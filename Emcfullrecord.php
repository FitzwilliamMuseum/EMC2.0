...
<div id="fullrecimg"><img  class=coinimg src='http://www-img.fitzmuseum.cam.ac.uk/img/emc/300jpg/<?php echo  str_replace('.','_',$result['objNum']) . "obv.jpg" ?>' onError="imgError(this);"></img></div>
<div class="img_content">Reverse</div>
<div id="fullrecimg"><img  class=coinimg src='http://www-img.fitzmuseum.cam.ac.uk/img/emc/300jpg/<?php echo  str_replace('.','_',$result['objNum']) . "rev.jpg" ?>' onError="imgError(this);"></img></div>
</div>
</div>
</div>
</div>
